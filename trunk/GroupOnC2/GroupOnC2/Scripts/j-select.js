...
*		+ 28-Oct-2009 : version 2.0
*          - append the drop list container to body, not in the wrapper to prevent slow performance when append dynamically to body per time show
*--------------------------------------------*
*/
...
$selectDroplist_UI = function (jEl, options) { //jEl = jquery element
    ...
    this.setupDropListUI = function () {
        ...
        //append to DOM
        o.el.html(o.elUL);
        if (options.endinglayout != null) {
            o.el.append(options.endinglayout)
            //options.onchange.call(this, self.attr("value"));
        }
        //o.el.append("<div class='select_bottom'></div>");
...
jQuery.fn.extend({
    addSelectUI: function () {
        ...
        if (options.endinglayout == null) {
            options.endinglayout = "<div class='select_bottom'></div>";
        }
        this.each(function () {
